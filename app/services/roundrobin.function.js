System.register([], function(exports_1, context_1) {
    ...
    exports_1("setupRoundRobin", setupRoundRobin);
    ...
    function roundRobin(players, formula) {
        var rounds = [];
        for (var round = 0; round < formula.length; round++) {
            rounds[round] = [];
        }
        for (var round = 0; round < formula.length; round++) {
            rounds[round] = rounds[round] ? [] : rounds[round];
            for (var match = 0; match < formula[round].length; match++) {
...
//# sourceMappingURL=roundrobin.function.js.map